...
class EventHandler {
	...
	EventHandler(final GameService gameService) {
		...
		log.info("------------ EventHandler : EventHandler START ------------");
		this.gameService = gameService;
		
		log.info("------------ EventHandler : EventHandler END ------------");
	}

	@RabbitListener(queues = "${multiplication.queue}")
	void handleMultiplicationSolved(final MultiplicationSolvedEvent event) {
		
		log.info("------------ EventHandler : handleMultiplicationSolved START ------------");
...
//	@RabbitListener(queues = "${multiplication.queue}")
//	void handleMultiplicationSolved(String msg) {
//		
//		log.info("------------ EventHandler : handleMultiplicationSolved START ------------");
//		
//		
//		try {
//			log.info("------------ EventHandler : handleMultiplicationSolved : " + msg);
//		} catch (final Exception e) {
//			log.error("MultiplicationSolvedEvent 처리 시 에러", e);
//			// 해당 이벤트가 다시 큐로 들어가거나 두 번 처리되지 않도록 예외 발생
//			throw new AmqpRejectAndDontRequeueException(e);
